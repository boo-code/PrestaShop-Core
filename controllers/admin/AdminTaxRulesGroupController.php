...
class AdminTaxRulesGroupControllerCore extends AdminController
{
    ...
    protected function processCreateRule()
    {
        ...
        // The edited rule is reused exactly once, for the first rule generated by this save.
        // Resetting the flag per country made every country reuse it in turn, so a selection of
        // several countries - "All" in particular - left a single rule carrying the last country.
        $first = true;
