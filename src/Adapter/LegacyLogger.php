...
class LegacyLogger implements LoggerInterface
{
    ...
    public function log($level, $message, array $context = []): void
    {
        ...
        // Without it the entry is attributed to whatever employee the legacy context happens to
        // hold, which is nobody yet while an employee is still being authenticated.
        $id_employee = !empty($context['id_employee']) ? $context['id_employee'] : null;
