...
class ToolsTest extends TestCase
{
    ...
    public function providerReplaceAccentedChars(): array
    {
        return [
            ['(C)', '©'],
            ['a', 'aàáâãäåāăąǎǟǡǻȁȃȧάαаأაḁẚạảấầẩẫậắằẳẵⱥａ'],
            ['A', 'AÀÁÂÃÄÅĀĂĄǍǞǠǺȀȂȦȺΆΑАḀẠẢẤẦẨẪẬẮẰẲẴẶἈἊἌᾸᾹᾺＡ'],
            ['aa', 'ꜳ'],
            ['AA', 'Ꜳ'],
            ['ae', 'æǣǽ'],
            ['AE', 'ÆǢǼ'],
            ...
            ['Dz', 'ǅǲ'],
            ['DZ', 'ǄǱ'],
            ['e', 'eèéêëēĕėęěȅȇȩɇɛέεеэეḕḗḙḛḝẹẻẽếềểễệἐἒἔὲｅ'],
            ['E', 'EÈÉÊËĒĔĖĘĚƐȄȆȨΈΕЕЭḔḖḘḚḜẸẺẼẾỀỂỄỆἘἚἜῈＥ'],
            ['f', 'fƒфفḟꝼｆ'],
            ['F', 'FƑФḞꝻＦ'],
            ['ff', 'ﬀ'],
            ['fi', 'ﬁ'],
            ...
            ['H', 'HĤĦȞḢḤḦḨḪⱧＨ'],
            ['hv', 'ƕ'],
            ['i', 'iìíîïĩīĭįıǐȉȋɨΐίιϊиіიḭḯỉịἰἲἴἶῐῑῒῖῗｉ'],
            ['I', 'IÌÍÎÏĨĪĬĮİƗǏȈȊΊΙΪІИḬḮỈỊῘῙῚＩ'],
            ['ij', 'ĳ'],
            ['IJ', 'Ĳ'],
            ['j', 'jĵǰɉйјჯｊ'],
            ['J', 'JĴɈЙЈＪ'],
            ...
            ['th', 'θþϑث'],
            ['TH', 'ÞΘ'],
            ['u', 'uùúûüũūŭůűųưǔǖǘǚǜȕȗʉуუṳṵṷṹṻụủứừửữựｕ'],
            ['U', 'UÙÚÛÜŨŪŬŮŰŲƯǓǕǗǙǛȔȖɄУṲṴṶṸṺỤỦỨỪỬỮỰＵ'],
            ['v', 'vʋвვṽṿꝟｖ'],
            ['V', 'VƲВṼṾꝞＶ'],
            ['vy', 'ꝡ'],
            ['VY', 'Ꝡ'],
            ...
            ['Z', 'ZŹŻŽƵȤΖЗẐẒẔⱫⱿＺ'],
            ['zh', 'ჟ'],
            // Characters PrestaShop transliterates with two letters, where ICU uses one.
            // See StringModifier::TRANSLITERATION_OVERRIDES.
            ['zh', 'ж'],
            ['Zh', 'Ж'],
            ['kh', 'х'],
            ['Kh', 'Х'],
