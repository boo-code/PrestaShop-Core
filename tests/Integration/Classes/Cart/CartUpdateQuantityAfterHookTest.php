...
class CartUpdateQuantityAfterHookTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Install first: the module class is only autoloaded once PrestaShop instantiates the module,
        // so touching its static before that is a "class not found".
        $this->installModule();
        Ps_CartQtyAfterHookTest::$calls = [];
    }

    protected function tearDown(): void
    {
        if (class_exists(Ps_CartQtyAfterHookTest::class, false)) {
            Ps_CartQtyAfterHookTest::$calls = [];
        }
    ...
    public function testAddingAProductDispatchesTheHookAsAnAddition(): void
    {
        ...
        $this->assertCount(1, Ps_CartQtyAfterHookTest::$calls);
        $call = Ps_CartQtyAfterHookTest::$calls[0];
    ...
    public function testARejectedUpdateDispatchesNothing(): void
    {
        ...
        $this->assertSame([], Ps_CartQtyAfterHookTest::$calls);
    }
